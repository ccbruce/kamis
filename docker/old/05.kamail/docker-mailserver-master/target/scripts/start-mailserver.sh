...
source /opt/usr/bin/helpers/index.sh

# shellcheck source=./startup/variables-stack.sh
source /opt/usr/bin/variables-stack.sh

# shellcheck source=./startup/check-stack.sh
source /opt/usr/bin/check-stack.sh

# shellcheck source=./startup/setup-stack.sh
source /opt/usr/bin/setup-stack.sh

# shellcheck source=./startup/daemons-stack.sh
source /opt/usr/bin/daemons-stack.sh

...
from app_store_plugin.get import CollectionGetMixin
...
from app_store_plugin.create_collection import StorageCreateCollectionMixin
...
class Collection(
    ...
    def last_modified(self):
        ...
        relevant_files = chain(
            ...
            (os.path.join(osprefix + self._filesystem_path, h) for h in self._list()))

...
if expr "$1" : "apache" 1>/dev/null || [ "$1" = "php-fpm" ] || [ "${NEXTCLOUD_UPDATE:-0}" -eq 1 ]; then
    ...
    (
        ...
        # shellcheck disable=SC2016
        image_version="$(php -r 'require "/opt/src/app/nextcloud/version.php"; echo implode(".", $OC_Version);')"
        ...
        if version_greater "$image_version" "$installed_version"; then
            ...
            rsync $rsync_options --delete --exclude-from=/upgrade.exclude /opt/src/app/nextcloud/ /var/www/html/
            for dir in config data custom_apps themes; do
                if [ ! -d "/var/www/html/$dir" ] || directory_empty "/var/www/html/$dir"; then
                    rsync $rsync_options --include "/$dir/" --exclude '/*' /opt/src/app/nextcloud/ /var/www/html/
                fi
            done
            rsync $rsync_options --include '/version.php' --exclude '/*' /opt/src/app/nextcloud/ /var/www/html/
